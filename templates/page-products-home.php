...
<script>
	...
	function toggleFilter(){
		var filter = document.getElementById("st-filter");
...
<div>
	<div class="st-myshop-search" style="margin:auto; padding:10px 20px;">
		...
		<div id="filterContainer" class="menu-main">
			<div class="menu-container" id="st-filter" style="display:none">
			...
			<div class="st-filter-btn" onclick="toggleFilter()"><img src="<?php echo $path ?>/images/Filter-Icon.png" loading="lazy" alt="" class="st-filter-img"><div>Filter</div></div>
		</div>
