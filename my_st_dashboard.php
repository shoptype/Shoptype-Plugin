...
function st_dashboard_tab_content() {
    ...
    <div class="st-redirect">
      ...
      <div class="st-redirect-btn-div">
        <a href="https://app.shoptype.com/" class="st-redirect-btn w-inline-block" target="_blank"><img src="<?php echo plugin_dir_url( __FILE__ ) ?>/images/Shoptype-Logo-White-1.png" loading="lazy" alt="" class="st-redirect-btn-image">
